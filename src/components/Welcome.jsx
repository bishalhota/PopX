        ...
        <div className=" bg-gray-50 flex justify-center px-4 ">
            <div className="h-screen max-w-md w-full bg-white rounded-lg shadow-md  flex justify-center items-end mt-2 ">
                <div className='w-full px-8 mb-2'>
                    ...
                    <button onClick={handleSignup} className="w-full bg-[#6C25FF] hover:bg-[#6C25FF] text-white font-medium py-2 px-4 rounded-md mb-4 transition duration-200 cursor-pointer">
                        Create Account
                    </button>

                    <button className="w-full bg-[#6C25FF4B] hover:bg-[#6C25FF4B] text-black font-medium py-2 px-4 rounded-md mb-4 transition duration-200 cursor-pointer">
